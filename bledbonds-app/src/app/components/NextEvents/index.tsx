...
import getAllEventsPast from "@/app/api/events/getAllEventsPast";

export default function PrevEvents(props: {
  prev?: boolean
  next?: boolean
}) {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      props.next ? setEvents(await getAllEventsFuture()) : setEvents(await getAllEventsPast());
    }
    fetchEvents();
  }, [])
