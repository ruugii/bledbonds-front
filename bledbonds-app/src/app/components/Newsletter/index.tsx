                ...
                <div className="p-8 border shadow-lg rounded-md bg-palette-1 h-[80%] w-[80%]">
                    <div className="text-center h-full">
                        <div className="text-palette-11 flex justify-end">
                            <Button onClick={() => setOpenModal(!openModal)} className='bg-transparent flex flex-row justify-end border-none w-full'>
                                <Close />
                            </Button>
                        </div>
                        <div className="flex flex-row h-[90%] content-center items-center justify-center">
                            <div className="flex flex-col w-full">
                                <h3 className="text-2xl font-bold text-palette-11">REGISTRATE A LA NEWSLETTER DE BLEDBONDS Y VAS A ESTAR INFORMADO DE TODAS NUESTRAS NOVEDADES</h3>
