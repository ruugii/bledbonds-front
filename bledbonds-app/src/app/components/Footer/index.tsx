...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="bg-palette-3 dark:bg-palette-950">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-palette-950 uppercase dark:text-palette-50">Paginas de interés</h2>
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-palette-950 uppercase dark:text-palette-50">Siguenos</h2>
                <ul className="text-palette-950 dark:text-palette-50 font-medium">
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-palette-950 uppercase dark:text-palette-50">Politicas</h2>
                <ul className="text-palette-950 dark:text-palette-50 font-medium">
