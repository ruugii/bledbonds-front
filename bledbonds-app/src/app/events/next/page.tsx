...
export const metadata: Metadata = {
  title: "Proximos eventos de BledBonds - Citas para personas con discapacidad",
  ...
  return (
    <div className="items-center content-center justify-center bg-palette-3 dark:bg-palette-11 flex-col">
      <div className="w-[80%] my-4 mx-auto">
        <Title bold width>
          Proximos eventos de BledBonds
        </Title>
        <Subtitle bold left width className="mt-4">
          Descubre cuales son los proximos eventos organizados por BledBonds
        </Subtitle>
        <NextEvents
          next
        />
