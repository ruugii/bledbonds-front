...
export const metadata: Metadata = {
  title: "Bled Bonds - Citas para personas con discapacidad - Importancia de los eventos inclusivos",
  ...
  return (
    <div className="flex items-center content-center justify-center bg-palette-3 dark:bg-palette-11 flex-col">
      <div className="w-[80%] my-4">
        ...
        <Text className="mt-4">
          Imagina que vas a un evento, y te encuentras que no puedes acceder a la sala porque la puerta es muy pequeña. Pues esta es la situacion en la que se encuentran millones de personas.
        </Text>
        <Text className="mt-4">
        ...
        <Text>
          ...
          <br />
          En un evento inclusivo, todas las personas, independientemente de su origen, capacidades o experiencias, se sienen valoradas y se sienten parte integral del evento.
          <br />
        ...
        <Text>
          ...
          <br />
          ¡Vamos a hablarte un poco de nosotros! En Singularis Catering creamos experiencias culinarias que son un homenaje a la pluralidad de gustos y preferencias, garantizando que cada bocado sea una experiencia única y deliciosa.
          <br />
          Gracias a nuestra amplia experiencia, nos esforzamos en cada evento por trascender las expectativas gastronómicas y llevar la inclusividad a la mesa de una manera deliciosa. Nos adaptamos a necesidades dietéticas específicas, personalizando menús que reflejen la identidad del evento.
          <br />
